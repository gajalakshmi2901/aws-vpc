...
resource "aws_db_subnet_group" "this" {
  count = var.create_aurora && var.create_db_subnet_group ? 1 : 0
...
resource "aws_rds_cluster_instance" "this" {
  for_each = { for k, v in var.instances : k => v if var.create_aurora && !local.is_serverless }
...
resource "aws_rds_cluster_endpoint" "this" {
  for_each = { for k, v in var.endpoints : k => v if var.create_aurora && !local.is_serverless }
...
resource "aws_rds_cluster_role_association" "this" {
  for_each = { for k, v in var.iam_roles : k => v if var.create_aurora }
...
locals {
  create_monitoring_role = var.create_aurora && var.create_monitoring_role && var.monitoring_interval > 0
}
...
resource "aws_appautoscaling_target" "this" {
  count = var.create_aurora && var.autoscaling_enabled && !local.is_serverless ? 1 : 0
...
resource "aws_security_group" "this" {
  count = var.create_aurora && var.create_security_group ? 1 : 0
...
resource "aws_security_group_rule" "this" {
  for_each = { for k, v in var.security_group_rules : k => v if var.create_aurora && var.create_security_group }
...
resource "aws_rds_cluster_parameter_group" "this" {
  count = var.create_aurora && var.create_db_cluster_parameter_group ? 1 : 0
...
resource "aws_db_parameter_group" "this" {
  count = var.create_aurora && var.create_db_parameter_group ? 1 : 0
...
resource "aws_cloudwatch_log_group" "this" {
  for_each = toset([for log in var.enabled_cloudwatch_logs_exports : log if var.create_aurora && var.create_cloudwatch_log_group && !var.cluster_use_name_prefix])
...
resource "aws_rds_cluster_activity_stream" "this" {
  count = var.create_aurora && var.create_db_cluster_activity_stream ? 1 : 0
